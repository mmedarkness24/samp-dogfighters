	...
	switch(dialogid)
	{
	    ...
	    case DIALOG_SELECT_LANGUAGE:
	    {
			...
			if (_serverPlayers[playerid][language] == PLAYER_LANGUAGE_ENGLISH)
			    ...
			    SendClientMessage(playerid, COLOR_SYSTEM_MAIN, "��������� �� ������� ������ ����� ��������� �� �������");
	    }
...
dcmd_vehicle(playerid, params[])
{
	...
	if (vehID < 400 || vehID > 605)
	{
	    if(_serverPlayers[playerid][language] == PLAYER_LANGUAGE_ENGLISH)
		    ...
		    SendClientMessage(playerid, COLOR_SYSTEM_MAIN, "[/vehicle]: �������� ID ���������� 173");
		return 1;
	}
	if (VEHICLES_FORBIDDEN_MODELS_CHECK)
	{
	    if(_serverPlayers[playerid][language] == PLAYER_LANGUAGE_ENGLISH)
		    ...
		    SendClientMessage(playerid, COLOR_SYSTEM_MAIN, "[/vehicle]: �������� ID ���������� 181");
		return 1;
	}
	...
	format(messageRussian, sizeof(messageRussian), "����� %s [%d] ��������� ����� ���������: %d", _serverPlayers[playerid][name], playerid, vehID);
...
dcmd_heal(playerid, params[])
{
	...
	{
	    sendLocalizedMessage("������������ �����, ������ $1000", "Not enough money. $1000 is needed", COLOR_SYSTEM_DISCORD, _serverPlayers);
	    return 1;
	}
	...
	format(messageRussian, sizeof(messageRussian), "����� %s [%d] ��� ������", _serverPlayers[playerid][name], playerid);
	sendLocalizedMessage(messageRussian, messageEnglish, COLOR_SYSTEM_DISCORD, _serverPlayers);
	return 1;
}
...
dcmd_teleport(playerid, params[])
{
	...
	{
	    sendLocalizedMessage("������������ �����, ������ $100", "Not enough money. $1000 is needed", COLOR_SYSTEM_DISCORD, _serverPlayers);
	    return 1;
	}
	...
	if (x == 0 && y == 0 && z == 0)
	{
	    if(_serverPlayers[playerid][language] == PLAYER_LANGUAGE_ENGLISH)
		    ...
		    SendClientMessage(playerid, COLOR_SYSTEM_MAIN, "[/teleport]: ������ ����� ����������");
		return 1;
	}
    new vehID = GetPlayerVehicleID(playerid);
    if (vehID != 0)
